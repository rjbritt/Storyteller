...
{
    self.appDelegate.currentStory = self.storyList[indexPath.row];
    
    UIStoryboard *theStoryboard = self.storyboard;
    UIViewController *nextViewController = [theStoryboard instantiateViewControllerWithIdentifier:@"STStoryViewController"];
