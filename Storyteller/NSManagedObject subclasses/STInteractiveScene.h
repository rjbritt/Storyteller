...
@class STActor, STEnvironment, STObject, STStory;

@interface STInteractiveScene : NSManagedObject

@property (nonatomic, retain) NSString * name;
@property (nonatomic) int64_t npcTagIncr;
@property (nonatomic) int64_t tag;
@property (nonatomic) int64_t pcTagIncr;
@property (nonatomic) int64_t envTagIncr;
